...
def load_settings_toml():
    try:
        ...
        print('WARNING: Invalid settings file.'
              'Please ensure all options are set.')
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="""A tool for splitting
                                                 multi-page PDF drawings into
                                                 seperate files named by
                                                 drawing number.""")
    parser.add_argument('dwg_number_element',
                        metavar='dwg-number-element',
                        type=str,
                        help="""The part of the drawing number to be searched
                             for""",
                        nargs='?',
    ...
    region_group.add_argument('-p',
                              ...
                              help="""Preset region of PDF containing drawing
                                   number. Choose from: 'top-left',
                                   'top-right', 'bot-left', 'bot-right', 'all'
                                   (DEFAULT: bot-right)""",
